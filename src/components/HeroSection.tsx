...
export default function HeroSection() {
  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8 bg-white relative overflow-hidden">
      {/* Decorative background blobs, adjusted for smaller screens */}
      <div className="absolute w-72 h-72 md:w-96 md:h-96 bg-blue-100 rounded-full blur-3xl opacity-30 top-10 left-[-150px] md:left-[-100px] z-0" />
      <div className="absolute w-64 h-64 md:w-80 md:h-80 bg-purple-100 rounded-full blur-3xl opacity-30 bottom-[-120px] right-[-150px] md:bottom-[-80px] md:right-[-100px] z-0" />
      ...
      >
        ...
        <div className="logos w-full max-w-xl mt-8 flex flex-row justify-center items-center gap-6 md:gap-8">
          {/* Note: Added classNames to SVGs and changed fill/stroke to "currentColor" */}
          <svg
            className="w-10 h-10 md:w-12 md:h-12 text-gray-700 transition-transform hover:scale-110"
            viewBox="0 0 24 24"
            fill="none"
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              <path
                ...
                stroke="currentColor" // Changed from #000000
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
              ></path>
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              <path
                ...
                fill="currentColor" // Changed from #000000
              ></path>
            </g>
          </svg>
